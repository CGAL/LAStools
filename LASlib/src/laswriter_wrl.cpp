...
las_BOOL LASwriterWRL::open(const CHAR* file_name, const LASheader* header, const CHAR* parse_string)
{
  if (file_name == 0)
  {
...
las_BOOL LASwriterWRL::open(FILE* file, const LASheader* header, const CHAR* parse_string)
{
  if (file == 0)
  {
...
las_BOOL LASwriterWRL::write_point(const LASpoint* point)
{
...
las_BOOL LASwriterWRL::update_header(const LASheader* header, las_BOOL use_inventory, las_BOOL update_extra_bytes)
{
  return TRUE;
}

I64 LASwriterWRL::close(las_BOOL update_header)
{
  if (file == 0)
  {
    return 0;
