...
las_BOOL LASwriterBIN::refile(FILE* file)
{
...
las_BOOL LASwriterBIN::open(const char* file_name, const LASheader* header, const char* version, U32 io_buffer_size)
{
  if (file_name == 0)
  {
...
las_BOOL LASwriterBIN::open(FILE* file, const LASheader* header, const char* version)
{
  if (file == 0)
  {
...
las_BOOL LASwriterBIN::open(ByteStreamOut* stream, const LASheader* header, const char* version)
{
  if (stream == 0)
  {
...
las_BOOL LASwriterBIN::write_point(const LASpoint* point)
{
  U16 echo;
...
las_BOOL LASwriterBIN::update_header(const LASheader* header, las_BOOL use_inventory, las_BOOL update_extra_bytes)
{
  return TRUE;
}

I64 LASwriterBIN::close(las_BOOL update_header)
{
  I64 bytes = 0;
