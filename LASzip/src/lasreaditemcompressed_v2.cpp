...
las_BOOL LASreadItemCompressed_POINT10_v2::init(const U8* item)
{
  U32 i;
...
las_BOOL LASreadItemCompressed_GPSTIME11_v2::init(const U8* item)
{
  /* init state */
  last = 0, next = 0;
...
las_BOOL LASreadItemCompressed_RGB12_v2::init(const U8* item)
{
  /* init state */
...
las_BOOL LASreadItemCompressed_BYTE_v2::init(const U8* item)
{
  U32 i;
  /* init state */
