...
inline las_BOOL ByteStreamInIstream::isSeekable() const
{
...
inline las_BOOL ByteStreamInIstream::seek(const I64 position)
{
  if (tell() != position)
  {
...
inline las_BOOL ByteStreamInIstream::seekEnd(const I64 distance)
{
