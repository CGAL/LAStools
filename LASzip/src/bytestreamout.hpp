...
public:
/* write single bits                                         */
  inline las_BOOL putBits(U32 bits, U32 num_bits)
  {
    U64 new_bits = bits;
...
/* write a single byte                                       */
  virtual las_BOOL putByte(U8 byte) = 0;
/* write an array of bytes                                   */
  virtual las_BOOL putBytes(const U8* bytes, U32 num_bytes) = 0;
/* write 16 bit low-endian field                             */
  virtual las_BOOL put16bitsLE(const U8* bytes) = 0;
/* write 32 bit low-endian field                             */
  virtual las_BOOL put32bitsLE(const U8* bytes) = 0;
/* write 64 bit low-endian field                             */
  virtual las_BOOL put64bitsLE(const U8* bytes) = 0;
/* write 16 bit big-endian field                             */
  virtual las_BOOL put16bitsBE(const U8* bytes) = 0;
/* write 32 bit big-endian field                             */
  virtual las_BOOL put32bitsBE(const U8* bytes) = 0;
/* write 64 bit big-endian field                             */
  virtual las_BOOL put64bitsBE(const U8* bytes) = 0;
/* is the stream seekable (e.g. standard out is not)         */
  virtual las_BOOL isSeekable() const = 0;
/* get current position of stream                            */
  virtual I64 tell() const = 0;
/* seek to this position in the stream                       */
  virtual las_BOOL seek(const I64 position) = 0;
/* seek to the end of the file                               */
  virtual las_BOOL seekEnd() = 0;
/* constructor                                               */
