...
las_BOOL LASwriteItemCompressed_POINT10_v2::init(const U8* item)
{
  U32 i;
...
inline las_BOOL LASwriteItemCompressed_POINT10_v2::write(const U8* item)
{
...
las_BOOL LASwriteItemCompressed_GPSTIME11_v2::init(const U8* item)
{
  /* init state */
  last = 0, next = 0;
...
inline las_BOOL LASwriteItemCompressed_GPSTIME11_v2::write(const U8* item)
{
...
las_BOOL LASwriteItemCompressed_RGB12_v2::init(const U8* item)
{
  /* init state */
...
inline las_BOOL LASwriteItemCompressed_RGB12_v2::write(const U8* item)
{
  I32 diff_l = 0;
  I32 diff_h = 0;
  I32 corr;
...
las_BOOL LASwriteItemCompressed_BYTE_v2::init(const U8* item)
{
  U32 i;
  /* init state */
...
inline las_BOOL LASwriteItemCompressed_BYTE_v2::write(const U8* item)
{
  U32 i;
  I32 diff;
  for (i = 0; i < number; i++)
