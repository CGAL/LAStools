...
las_BOOL LASreadItemCompressed_POINT10_v1::init(const U8* item)
{
  U32 i;
...
las_BOOL LASreadItemCompressed_GPSTIME11_v1::init(const U8* item)
{
  /* init state */
  last_gpstime_diff = 0;
...
las_BOOL LASreadItemCompressed_RGB12_v1::init(const U8* item)
{
  /* init state */
...
las_BOOL LASreadItemCompressed_WAVEPACKET13_v1::init(const U8* item)
{
  /* init state */
  last_diff_32 = 0;
...
las_BOOL LASreadItemCompressed_BYTE_v1::init(const U8* item)
{
  /* init state */
